    ...
    <>
      {!open && (
        <button
          ...
          className="fixed bottom-24 right-4 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-primary to-primary/80 shadow-elegant transition-all hover:scale-110 hover:shadow-xl active:scale-95 sm:bottom-6 sm:right-6"
